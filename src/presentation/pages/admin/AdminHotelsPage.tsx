...
import HotelMediaDialog from '@/presentation/components/admin/hotels/HotelMediaDialog'
...
export default function AdminHotelsPage() {
  ...
  const [mediaHotel, setMediaHotel] = useState<AdminHotel | null>(null)
