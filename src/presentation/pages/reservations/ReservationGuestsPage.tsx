...
export default function ReservationGuestsPage() {
  ...
  useEffect(() => {
    setGuests(createGuestForms(selections))
  }, [selections])
    ...
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {submissionError && (
        ...
        >
          <AlertDescription>
            {submissionError}
            {submissionError.includes('perfil') && (
              <Button
                className="mt-3"
                size="sm"
                variant="outline"
            ...
            <CardContent className="space-y-4">
              ...
              {pricingPreview && (
                <>
                  ...
                  {pricingPreview.servicesSubtotal > 0 && (
                    <div className="flex justify-between gap-3 text-sm">
                      <span className="text-muted-foreground">
                        Servicios adicionales
                      </span>
                      ...
                      <span>
                        {formatCurrency(
                          pricingPreview.servicesSubtotal,
